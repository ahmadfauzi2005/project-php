...
$identitas_result2 = mysqli_query($link, "SELECT * FROM jenis_angsuran");
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h2>Tambahkan Data angsuran</h2>
                    </div>
                    <p>isi kan from dengan data yang valid</p>
                    <form action="proses.php" method="post">
                        <div class="form-group">
                        <label>Angsuran</label>
                            <input type="text" name="angsuran" id="angsuran" class="form-control" required>

                        </div>
                        <div>
                        <label>Jenis</label>

                        <select name="id_jenis" id="produk" class="form-control">
                                <?php
                                while ($identitas = mysqli_fetch_array($identitas_result2)) {
                                    echo "<option value='".$identitas['jenis']."'> ".$identitas['jenis']."</option>";
                                }
                                ?>
                            </select>
                        </div>
